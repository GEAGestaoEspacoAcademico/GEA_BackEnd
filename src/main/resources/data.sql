...
INSERT INTO RECURSOS (NOME, TIPO) VALUES
    ...
    ('Mouse USB Óptico', 'Hardware'),
    ('Computador Desktop i5 (Ensino)', 'Hardware'),
    ('Licença Pacote Adobe Creative Cloud', 'Software'),
    ('Kit Arduino Uno (Iniciante)', 'Hardware'),
    ('Lousa Digital Interativa (Smart Board)', 'Hardware'),
    ('Filamento PLA (Branco, 1kg)', 'Hardware'),
    ('Mesa de Reunião (6 lugares)', 'Mobiliário');
