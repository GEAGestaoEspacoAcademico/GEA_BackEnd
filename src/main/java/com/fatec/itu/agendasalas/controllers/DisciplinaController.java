...
public class DisciplinaController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Disciplina atualizada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DisciplinaListDTO.class), examples = @ExampleObject(value = "{ \"id\": 1, \"nome\": \"Algoritmos e Estruturas\" }"))),
            @ApiResponse(responseCode = "404", description = "Disciplina não encontrada")
    })
    ...
    public ResponseEntity<DisciplinaListDTO> editarDisciplina(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Novos dados para a disciplina", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = DisciplinaCreateDTO.class), examples = @ExampleObject(value = "{ \"nome\": \"Algoritmos e Estruturas\" }"))) @RequestBody DisciplinaCreateDTO novaDisciplina) {
