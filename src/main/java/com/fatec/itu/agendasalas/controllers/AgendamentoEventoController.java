...
public class AgendamentoEventoController {
    ...
    @ApiResponses(value = {
        ...
        content = @Content(mediaType = "application/json",
          ...
          examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
            value = "[ { \"agendamentoEventoId\": 11, \"usuarioNome\": \"Prof. Francisco Bianchi\", \"salaNome\": \"Lab 303\", \"eventoNome\": \"InterFATECS\", \"data\": \"2025-11-15\", \"diaDaSemana\": \"Sexta-feira\", \"horaInicio\": \"09:30:00\", \"horaFim\": \"11:20:00\", \"isEvento\": true, \"recorrenciaId\": 2, \"status\": \"ATIVO\", \"solicitante\": \"Sistema\" } ]")))
    })
    @GetMapping
