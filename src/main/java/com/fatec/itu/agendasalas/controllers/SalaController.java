...
public class SalaController {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Sala encontrada",
      content = {@Content(mediaType = "application/json",
          schema = @Schema(implementation = SalaDetailDTO.class), examples = @ExampleObject(
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Sala criada com sucesso",
      content = {@Content(mediaType = "application/json",
          schema = @Schema(implementation = SalaDetailDTO.class), examples = @ExampleObject(
              value = "{ \"id\": 1,\"nome\": \"Sala 101\", \"capacidade\": 10, \"piso\": 2, \"disponibilidade\": false, \"tipoSala\": \"Sala\", \"observacoes\": \"Sala com notebooks\"}"))})})
  public ResponseEntity<SalaDetailDTO> criar(@io.swagger.v3.oas.annotations.parameters.RequestBody(
