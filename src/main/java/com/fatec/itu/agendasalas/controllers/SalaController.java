        ...
        @ApiResponse(responseCode = "200",
            ...
            content = @Content(mediaType = "application/json",
                ...
                examples = @ExampleObject(
                    value = "{ \"salaId\": 1, \"salaNome\": \"Sala 101\", \"capacidade\": 10, \"andarId\": 2, \"disponibilidade\": false, \"tipoSala\": \"Sala de Aula\", \"salaObservacoes\": \"Sala com notebooks\" }")))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201",
            ...
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = SalaDetailDTO.class),
                examples = @ExampleObject(
                    value = "{ \"tipoSalaId\": 1, \"salaNome\": \"Nova Sala\", \"salaCapacidade\": 10, \"andarId\": 1, \"disponibilidade\": true, \"salaObservacoes\": \"Sala em perfeito estado\" }")))
    })
